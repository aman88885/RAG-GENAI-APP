...
import { FileText, Upload, File, X, CheckCircle, Loader, AlertCircle, MessageCircle, Clock, RefreshCw } from 'lucide-react';
...
interface UploadedPDF {
  ...
  indexing_status: 'indexed' | 'failed' | 'processing';
  uploaded_at?: string;
}
...
const Dashboard = () => {
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:4000/api/v1/pdf/new', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
        },
      ...
      if (response.ok) {
        ...
        if (data.success && data.pdf) {
          ...
          if (data.pdf.indexing_status === 'indexed') {
            showToast('PDF indexed successfully and stored in vector DB.', 'success');
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Upload your PDF documents and start intelligent conversations
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Upload Section */}
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <h2 className="text-2xl font-bold text-black mb-6">Upload PDF</h2>
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-sm font-medium text-gray-700">
                            {uploadResult ? 'Upload Complete' : 'Uploading...'}
                          </span>
                    ...
                    {isUploading && (
                      <div className="flex items-center space-x-2 text-blue-600">
                        ...
                        <span className="text-sm">Uploading and indexing your PDF...</span>
                      </div>
                    )}

                    {uploadResult && uploadResult.indexing_status === 'indexed' && (
                      <div className="flex items-center space-x-2 text-green-600">
                        <CheckCircle className="h-4 w-4" />
                        <span className="text-sm">PDF indexed successfully and stored in vector DB.</span>
                      </div>
                    )}
